...
class OthersBadge extends StatefulWidget {
  @override
  _OthersBadgeState createState() => _OthersBadgeState();
}

class _OthersBadgeState extends State<OthersBadge> {
  int _counter = 0;
  ...
  Widget _shoppingCartBadge() {
    return Badge(
      ...
      child: IconButton(color: Colors.black, icon: Icon(Icons.shopping_cart), onPressed: () {}),
    );
  }
